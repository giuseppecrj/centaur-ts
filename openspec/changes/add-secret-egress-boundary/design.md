...
This change covers: **Add secret and egress boundary**.
...
- Scope creep → Keep this change bounded to `secret-egress-boundary` and use separate OpenSpec changes for neighboring subsystems.
