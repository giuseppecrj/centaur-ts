...
This change covers: **Add delivery clients and outbox**.
...
- Scope creep → Keep this change bounded to `delivery-clients-outbox` and use separate OpenSpec changes for neighboring subsystems.
