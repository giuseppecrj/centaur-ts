...
This change covers: **Add observability, operations, and deploy**.
...
- Scope creep → Keep this change bounded to `observability-operations-deploy` and use separate OpenSpec changes for neighboring subsystems.
