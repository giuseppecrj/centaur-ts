...
This change covers: **Expose agent HTTP protocol**.
...
- Scope creep → Keep this change bounded to `agent-http-protocol` and use separate OpenSpec changes for neighboring subsystems.
