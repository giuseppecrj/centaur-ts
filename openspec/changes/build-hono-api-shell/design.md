...
This change covers: **Build Hono API shell**.
...
- Scope creep → Keep this change bounded to `hono-api-shell` and use separate OpenSpec changes for neighboring subsystems.
