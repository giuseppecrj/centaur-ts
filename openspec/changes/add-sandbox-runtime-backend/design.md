...
This change covers: **Add sandbox runtime backend**.
...
- Scope creep → Keep this change bounded to `sandbox-runtime-backend` and use separate OpenSpec changes for neighboring subsystems.
