...
This change covers: **Implement control-plane services**.
...
- Scope creep → Keep this change bounded to `control-plane-services` and use separate OpenSpec changes for neighboring subsystems.
