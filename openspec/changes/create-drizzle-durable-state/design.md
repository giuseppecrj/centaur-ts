...
This change covers: **Create Drizzle durable state**.
...
- Scope creep → Keep this change bounded to `drizzle-durable-state` and use separate OpenSpec changes for neighboring subsystems.
