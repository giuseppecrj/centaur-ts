...
This change covers: **Build monorepo foundation**.
...
- Scope creep → Keep this change bounded to `monorepo-foundation` and use separate OpenSpec changes for neighboring subsystems.
