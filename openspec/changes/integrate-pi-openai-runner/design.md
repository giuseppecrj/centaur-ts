...
This change covers: **Integrate pi OpenAI runner**.
...
- Scope creep → Keep this change bounded to `pi-openai-runner` and use separate OpenSpec changes for neighboring subsystems.
