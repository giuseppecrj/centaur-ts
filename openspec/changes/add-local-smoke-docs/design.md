...
This change covers: **Add local smoke tests and docs**.
...
- Scope creep → Keep this change bounded to `local-smoke-docs` and use separate OpenSpec changes for neighboring subsystems.
