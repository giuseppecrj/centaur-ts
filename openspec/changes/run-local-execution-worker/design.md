...
This change covers: **Run local execution worker**.
...
- Scope creep → Keep this change bounded to `local-execution-worker` and use separate OpenSpec changes for neighboring subsystems.
