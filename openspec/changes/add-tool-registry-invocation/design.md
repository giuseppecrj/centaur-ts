...
This change covers: **Add tool registry and invocation**.
...
- Scope creep → Keep this change bounded to `tool-registry-invocation` and use separate OpenSpec changes for neighboring subsystems.
