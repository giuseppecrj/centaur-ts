...
This change covers: **Add extension overlay model**.
...
- Scope creep → Keep this change bounded to `extension-overlay-model` and use separate OpenSpec changes for neighboring subsystems.
