...
This change covers: **Add API key auth and admin**.
...
- Scope creep → Keep this change bounded to `api-key-auth-admin` and use separate OpenSpec changes for neighboring subsystems.
