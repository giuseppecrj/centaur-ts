...
This change covers: **Add workflow checkpoints**.
...
- Scope creep → Keep this change bounded to `workflow-checkpoints` and use separate OpenSpec changes for neighboring subsystems.
